            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg relative">
                        {avaliableCredits !== null && feature.required_credits > avaliableCredits && (
                            <div className="absolute left-0 top-0 right-0 bottom-0 z-20 flex flex-col items-center 
                                justify-center bg-white/70 gap-3">
